        ...
        goConversation: function(id) {
           ...
           $.getJSON('/conversation/'+id,function(data) {
                ...
                socket.addCallback('response',function(data) {
                    self.createResponse(true,data.user,data.date,data.content,data.avatar);
                });
                ...
                self.createResponse(false,data.discussion.user,data.discussion.date,data.discussion.content,data.discussion.avatar);
                ...
                _.each(data.responses,function(r) {
                    self.createResponse(false,r.user,r.date,r.content,r.avatar);
                });
                $("#discussion").show();

            }); 
        },
        createResponse: function(fadeIn,user,date,content,avatar) {
